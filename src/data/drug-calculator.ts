...
export const emsFormulary: DrugDosage[] = [
  {
    ...
    pediatricDose: {
      weightBased: "Not indicated for pediatric ACS",
      maxDose: "N/A",
      ageRestrictions: "Avoid in children and adolescents with viral illness (Reye syndrome)"
    },
    contraindications: ["Known allergy to aspirin/NSAIDs", "Active bleeding", "History of aspirin-induced bronchospasm"],
    warnings: ["GI Bleeding Management Techniques risk", "Tinnitus with overdose"]
  },
  {
    name: "Epinephrine",
  ...
  },
  {
    ...
    routes: ["IN", "IM", "IV"],
    adultDose: {
      amount: "2-4 mg IN (common device) or 0.4-2 mg IV/IM per local protocol",
      route: "IN/IV/IM",
      frequency: "q2-3min PRN to adequate ventilation"
    },
    pediatricDose: {
      weightBased: "0.1 mg/kg IV/IM (max 2 mg) or 2 mg IN (device-dependent)",
  ...
  },
  {
    ...
    indication: "Bronchospasm, Asthma exacerbation, COPD flare, Respiratory distress with wheezing",
    certificationLevel: "EMT",
    routes: ["Nebulized", "MDI"],
    adultDose: {
      amount: "2.5 mg in 3 mL NS (nebulizer) or 4-8 puffs (MDI w/ spacer)",
      route: "Nebulized at 6-8 L/min O₂ until dry (8-15 min) or MDI with 30 sec between puffs",
      frequency: "q20min PRN, max 2 doses",
      maxDose: "5 mg total"
    },
    pediatricDose: {
      weightBased: "1.25 mg in 3 mL NS (nebulizer) or 4-6 puffs (MDI w/ spacer)",
      maxDose: "2.5 mg per dose",
      ageRestrictions: "Use small-volume nebulizer for children, mask if <4 years"
    },
    contraindications: [
      "Known severe allergy to albuterol (rare)",
      "HR >150 bpm with chest pain/palpitations", 
      "No wheezing with severe distress (suspect upper airway obstruction)",
      "Cardiac wheezes (CHF): wheezing + crackles + JVD"
    ],
    warnings: [
      "Expected: Tremors, mild tachycardia, nervousness, headache",
      "DANGER SIGNS: Chest pain/palpitations, HR >180 bpm (pediatric), no improvement/worsening, new stridor/voice change",
      "Always give with supplemental O₂ (albuterol can temporarily ↓ SpO₂)",
      "Discard if cloudy - use clear solution only",
      "Keep nebulizer vials in foil pouch until use",
      "MDI requires spacer - without it, 80% less drug reaches lungs",
      "Shake MDI canister 5+ seconds before each puff",
      "Never delay transport for repeat dosing if patient is cyanotic, altered mental status, or speaking <3 words/breath",
      "Anaphylaxis with wheezing: give EPI first, then albuterol"
    ],
    interactions: [
      "Beta-blockers may reduce effectiveness",
      "MAOIs and tricyclic antidepressants may potentiate cardiovascular effects"
    ],
    mechanismOfAction: "Relaxes bronchial smooth muscle → opens airways, reduces airway resistance → ↓ wheezing, ↑ air entry",
    clinicalPearls: [
      ...
      "Pediatric: Have child 'seal lips' on spacer, count breaths for MDI",
      "Post-treatment documentation: Note ↓ wheezing, ↑ SpO₂ improvement"
    ]
  },
  {
    name: "Nitroglycerin",
  ...
  contraindications: ["SBP <90–100 mmHg (per protocol)", "Suspected right ventricular infarction", "PDE5 inhibitors within 24–48h (sildenafil/tadalafil/vardenafil)", "Head trauma/increased ICP"],
