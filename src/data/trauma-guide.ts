...
export const traumaProtocols: TraumaProtocol[] = [
  {
    ...
    category: 'assessment',
    steps: [
      'M - Massive Hemorrhage: Control life-threatening Bleeding Management Techniques first',
      'A - Airway: Secure airway with C-spine protection',
      'R - Respiratory: Assess breathing and treat pneumothorax',
      'C - Circulation: Check pulse, treat Shock Recognition & Response, IV access',
      'H - Hypothermia: Prevent heat loss, warm patient'
    ],
    criticalActions: [
      'Direct pressure for Bleeding Management Techniques',
      'Tourniquet for extremity hemorrhage',
      'Jaw thrust for airway',
      'Needle decompression for tension pneumo',
      'Fluid resuscitation for Shock Recognition & Response'
    ],
    redFlags: [
...
export const tourniquetGuide: TourniquetApplication = {
  indications: [
    ...
    'Arterial Bleeding Management Techniques not controlled by pressure',
    'Multiple casualties (triage situation)'
  ],
  contraindications: [
    'Venous Bleeding Management Techniques only',
    'Bleeding Management Techniques easily controlled by pressure',
    'Crush injuries with tissue destruction'
  ],
  steps: [
    'Place 2-3 inches above wound (closer to heart)',
    'Tighten until Bleeding Management Techniques stops completely',
