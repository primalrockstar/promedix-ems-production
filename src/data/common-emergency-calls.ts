...
export const commonEmergencyCalls: EmergencyCall[] = [
  ...
  },
  {
    ...
    secondaryDiagnoses: ['Traumatic Brain Injury', 'Hemorrhagic Shock Recognition & Response', 'Pneumothorax'],
    keyInterventions: [
      'Scene safety assessment',
      'C-spine immobilization',
      'Control major Bleeding Management Techniques',
      'High-flow oxygen',
  ...
  },
  {
    ...
    primaryDiagnosis: 'Anaphylactic Shock Recognition & Response',
  ...
  },
  {
    ...
    transportDecision: 'emergent',
    protocolReference: 'Toxicology Emergencies Protocol 10.0',
    commonMistakes: [
