...
const EMTBStudyNotesNew: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4 pb-24 lg:pb-8">
  ...
  <div className="bg-white rounded-lg shadow-lg p-4 md:p-6 mb-4 md:mb-6">
          ...
          {/* Navigation Tabs */}
          <div className="flex space-x-1 mt-4 md:mt-6 bg-gray-100 p-1 rounded-lg">
            {[
