...
export const simulationsData: Omit<Simulation, 'id'>[] = [
  ...
  {
    title: "Anaphylactic Shock Recognition & Response",
    description: "35-year-old woman develops severe allergic reaction after bee sting. Rapidly progressing to respiratory distress and Shock Recognition & Response.",
    ...
    learningObjectives: [
      ...
      "Provide supportive care for Shock Recognition & Response",
  ...
  },
  {
    ...
    category: "Toxicology Emergencies",
    difficulty: "beginner",
    estimatedTime: 12,
    scenario: {
      patient: {
