...
export const certificationProcedures: Procedure[] = [
  // EMT Level Procedures
  {
    ...
    category: 'Airway Management Techniques',
    difficulty: 'Basic',
    ...
    protocolReference: 'EMT Airway Management Techniques Protocol 3.1'
  },
  {
  ...
  },
  {
    ...
    description: 'Control of external Bleeding Management Techniques using direct pressure and tourniquets',
    certificationLevel: 'EMT',
    category: 'Trauma Management',
    difficulty: 'Basic',
    equipment: ['Gauze pads', 'Roller bandages', 'Tourniquet', 'Pressure dressing'],
    indications: ['External Bleeding Management Techniques', 'Arterial hemorrhage', 'Venous Bleeding Management Techniques'],
    ...
    steps: [
      {
        ...
        criticalAction: true,
        safetyNote: 'Wear gloves, eye protection, and gown if heavy Bleeding Management Techniques'
      },
      {
        stepNumber: 2,
        description: 'Expose the Bleeding Management Techniques site',
        criticalAction: true
      },
      {
        stepNumber: 3,
      ...
      {
        stepNumber: 4,
        description: 'If Bleeding Management Techniques continues, apply additional pressure',
        criticalAction: true
      },
      {
        stepNumber: 5,
        description: 'If Bleeding Management Techniques not controlled, apply tourniquet 2-3 inches above wound',
        criticalAction: true,
      ...
      {
        stepNumber: 6,
        description: 'Tighten tourniquet until Bleeding Management Techniques stops',
        criticalAction: true
      },
      {
        stepNumber: 7,
      ...
      {
        stepNumber: 8,
        description: 'Bandage wound and monitor for continued Bleeding Management Techniques',
        criticalAction: true,
        equipmentNeeded: ['Roller bandages']
      }
    ],
    complications: ['Tissue necrosis from tourniquet', 'Infection', 'Shock Recognition & Response from blood loss'],
    successCriteria: ['Bleeding Management Techniques controlled', 'Maintained circulation distal to injury', 'Stable vital signs'],
  ...
  },
  {
    ...
    steps: [
      ...
      {
        stepNumber: 8,
        description: 'Deliver Shock Recognition & Response if advised, then resume CPR',
        criticalAction: true,
        safetyNote: 'Immediately resume compressions after Shock Recognition & Response'
      }
    ],
    complications: ['Inappropriate Shock Recognition & Response', 'Electrical injury to rescuer', 'Delay in CPR'],
    successCriteria: ['Successful rhythm analysis', 'Appropriate Shock Recognition & Response delivery if indicated', 'Minimal CPR interruption'],
  ...
  // Paramedic Level Procedures
  {
    ...
    description: 'Definitive Airway Management Techniques via endotracheal tube placement',
  ...
  },
  {
    ...
    steps: [
      ...
      {
        stepNumber: 7,
        description: 'Deliver Shock Recognition & Response when ready',
        criticalAction: true
      },
      {
        stepNumber: 8,
  ...
  },
  {
    id: 'aed-operation',
    name: 'Automated External Defibrillator Operation',
    description: 'Use of AED for cardiac arrest with Shock Recognition & Responseable rhythms',
    certificationLevel: 'EMT',
    ...
    steps: [
      ...
      {
        stepNumber: 7,
        description: 'If Shock Recognition & Response advised, ensure clear and press Shock Recognition & Response button',
        criticalAction: true,
        safetyNote: 'Visually confirm no one touching patient'
      },
      {
        stepNumber: 8,
        description: 'Immediately resume CPR after Shock Recognition & Response',
        criticalAction: true
      }
    ],
    complications: ['Shock Recognition & Response to bystander', 'Burns from poor pad contact', 'Failure to Shock Recognition & Response VF/VT'],
    successCriteria: ['Successful rhythm analysis', 'Appropriate Shock Recognition & Response delivery', 'Return of pulse'],
  ...
  },
  {
    ...
    steps: [
      ...
      {
        stepNumber: 7,
        description: 'Deliver synchronized Shock Recognition & Response',
        criticalAction: true,
        safetyNote: 'May need to hold buttons until Shock Recognition & Response delivered'
      },
      {
        stepNumber: 8,
        description: 'Reassess rhythm and patient status',
...
export const proceduresByCategory = {
  'Airway Management Techniques': certificationProcedures.filter(proc => proc.category === 'Airway Management Techniques'),
